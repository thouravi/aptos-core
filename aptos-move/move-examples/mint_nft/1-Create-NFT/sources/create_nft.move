...
/// They are generally used as certificate / proof. Each NFT created from the base token is considered a printing edition of the
/// base token.
...
/// 2. Pfp NFT: this kind of NFT is unique. There are generally no printing editions of this NFT. Most NFT collections on NFT marketplaces
/// are of this kind. They are generally proofs of ownership of an art piece.
///
...
///
/// 3. Check out the `delayed_mint_event_ticket()` function below - we are not going to run a command to mint the NFT in this step, because
