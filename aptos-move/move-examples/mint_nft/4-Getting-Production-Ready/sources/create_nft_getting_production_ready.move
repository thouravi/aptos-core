...
/// We should run the following command in directory `aptos-core/aptos-move/move-examples/mint_nft/4-Getting-Production-Ready`.
...
/// aptos move run --function-id [resource account's address]::4-Getting-Production-Ready::set_public_key --args hex:[public key we just generated] --profile admin
/// (To find the public key we just generated, run `nano output.key.pub`.)
/// example output:
    /*
    4-Getting-Production-Ready % aptos move run --function-id f634035fea40e23c5ed8817f7e996d96372dd5dbd64e853fb3c108817d92dcb4::4-Getting-Production-Ready::set_public_key --args hex:5C0637A3865FCA80550502BC30C8E7B4CCA7C8AB3B4FFECEFC8C43F7D0D44DEE --profile admin
...
/// aptos move run --function-id [resource account's address]::4-Getting-Production-Ready::mint_event_ticket --args hex:[signature generated in last step] --profile nft-receiver
/// example output:
    /*
    4-Getting-Production-Ready % aptos move run --function-id f634035fea40e23c5ed8817f7e996d96372dd5dbd64e853fb3c108817d92dcb4::4-Getting-Production-Ready::mint_event_ticket --args hex:fc833512ad1c575850569d14f5e434b929a19eb491c08df9f6b91584a13551bdb95830081a429f148fddcb9ba201cf72a357957849046da0d60675ed034f580f --profile nft-receiver
